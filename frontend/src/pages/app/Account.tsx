// frontend/src/pages/app/Account.tsx
      ...
      <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_320px]">
        ...
        <aside className="card h-fit p-7">
          ...
          <div className="mt-6 space-y-2 text-sm">
            <Link to="/app/orders" className="block link-underline">Your orders</Link>
            <Link to="/app/rentals" className="block link-underline">Your bookings</Link>
            {(profile.role === 'farmer' || profile.role === 'cooperative') && (
              <Link to="/app/listings" className="block link-underline">My listings</Link>
            )}
          </div>
        </aside>
      </div>
