// frontend/src/pages/app/ManageListings.tsx
...
export default function ManageListings() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <header>
        <h1 className="text-section text-canopy">My Listings</h1>
        <p className="mt-2 max-w-xl text-soil/70">
          {profile?.role === 'cooperative'
            ? 'Supplies, the shared equipment pool, and member booking requests.'
            : 'What you sell, what you rent out, and who wants to book it.'}
        </p>
      </header>
